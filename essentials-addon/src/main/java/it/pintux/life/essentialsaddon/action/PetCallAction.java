...
public final class PetCallAction implements ActionSystem.ActionHandler {
    private final BedrockPetService service;

    public PetCallAction(BedrockPetService service) {
        this.service = service;
    }

    @Override
    public String getActionType() {
        return "essentials_pet_call";
    }
    ...
    public ActionSystem.ActionResult execute(FormPlayer player, String actionValue, ActionSystem.ActionContext context) {
        ...
        service.callPet(bukkitPlayer, PetActionPayloads.decodePet(actionValue));
        return ActionSystem.ActionResult.success("Called pet");
    }
    ...
    public String getDescription() {
        return "Calls/activates a pet";
    }

    @Override
    public String[] getUsageExamples() {
        return new String[]{"essentials_pet_call:<uuid>"};
    }
}
