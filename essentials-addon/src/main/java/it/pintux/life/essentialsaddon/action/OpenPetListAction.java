...
public final class OpenPetListAction implements ActionSystem.ActionHandler {
    private final BedrockPetService service;

    public OpenPetListAction(BedrockPetService service) {
        this.service = service;
    }

    @Override
    public String getActionType() {
        return "essentials_pet_main";
    }
    ...
    public ActionSystem.ActionResult execute(FormPlayer player, String actionValue, ActionSystem.ActionContext context) {
        ...
        return ActionSystem.ActionResult.success("Opened pet list");
    }
    ...
    public String getDescription() {
        return "Opens the Bedrock pet list";
    }

    @Override
    public String[] getUsageExamples() {
        return new String[]{"essentials_pet_main:"};
    }
}
