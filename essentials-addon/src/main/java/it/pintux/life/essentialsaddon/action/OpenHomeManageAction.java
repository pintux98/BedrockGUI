...
public final class OpenHomeManageAction implements ActionSystem.ActionHandler {
    private final BedrockHomeService service;

    public OpenHomeManageAction(BedrockHomeService service) {
    ...
    public ActionSystem.ActionResult execute(FormPlayer player, String actionValue, ActionSystem.ActionContext context) {
        ...
        service.showHomeManageForm(bukkitPlayer, homeName);
        return ActionSystem.ActionResult.success("Opened the manage form for home: " + homeName);
    }
    ...
    public String getDescription() {
        return "Opens the manage form for one home";
    }

    @Override
    public String[] getUsageExamples() {
        return new String[]{"home_manage:base", "home_manage:mine"};
    }
}
