...
public final class HomeMakePublicAction implements ActionSystem.ActionHandler {
    private final BedrockHomeService service;

    public HomeMakePublicAction(BedrockHomeService service) {
        this.service = service;
    }

    @Override
    public String getActionType() {
        return "home_make_public";
    }
    ...
    public String getDescription() {
        return "Makes one of the player\u0027s homes public";
    }

    @Override
    public String[] getUsageExamples() {
        return new String[]{"home_make_public:base"};
    }
}
