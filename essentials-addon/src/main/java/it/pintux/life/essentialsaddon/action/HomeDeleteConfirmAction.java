...
public final class HomeDeleteConfirmAction implements ActionSystem.ActionHandler {
    private final BedrockHomeService service;

    public HomeDeleteConfirmAction(BedrockHomeService service) {
        this.service = service;
    }

    @Override
    public String getActionType() {
        return "home_delete_confirm";
    }
    ...
    public ActionSystem.ActionResult execute(FormPlayer player, String actionValue, ActionSystem.ActionContext context) {
        ...
        service.deleteHome(bukkitPlayer, homeName);
        return ActionSystem.ActionResult.success("Deleted home: " + homeName);
    }
    ...
    public String getDescription() {
        return "Deletes the named home";
    }

    @Override
    public String[] getUsageExamples() {
        return new String[]{"home_delete_confirm:base"};
    }
}
