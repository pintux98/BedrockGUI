...
/** BedWars2023 implementation of {@link PartyProvider}. The ONLY party class touching com.tomkeuper.*. */
public final class BedWars2023PartyProvider implements PartyProvider {
    private final BedWarsApiAccess access;

    public BedWars2023PartyProvider(BedWarsApiAccess access) {
        this.access = access;
    }
