...
public class OpenUrlActionHandler extends BaseActionHandler {
    ...
    public ActionSystem.ActionResult execute(FormPlayer player, String actionValue, ActionSystem.ActionContext context) {
        if (!validateParameters(player, actionValue)) {
            ...
            return createFailureResult(MessageData.EXECUTION_ERROR, createReplacements("error", messageData.getValue(MessageData.ACTION_INVALID_PARAMETERS, null, player)), player);
        }
