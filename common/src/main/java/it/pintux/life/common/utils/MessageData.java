...
public class MessageData {
    ...
    public static String ACTION_LIST_SUCCESS = "action.list.success";
    public static String ACTION_LIST_NO_DATA = "action.list.no_data";
    public static String ACTION_LIST_INVALID_PAGE = "action.list.invalid_page";
    public static String ACTION_LIST_GENERATED = "action.list.generated";

    public static String SYSTEM_TEMPLATE_NOT_FOUND = "system.template_not_found";
    public static String SYSTEM_FORM_DISPLAY_ERROR = "system.form_display_error";
    public static String SYSTEM_FORM_SENT_SUCCESS = "system.form_sent_success";
    public static String SYSTEM_FORM_SEND_FAILED = "system.form_send_failed";
    public static String SYSTEM_UNEXPECTED_ERROR = "system.unexpected_error";
    ...
    public static String VALIDATION_INVALID_IMAGE_SOURCE = "validation.invalid_image_source";
    public static String VALIDATION_INVALID_ACTION_FORMAT = "validation.invalid_action_format";
    public static String VALIDATION_INVALID_DELAY_FORMAT = "validation.invalid_delay_format";
    public static String VALIDATION_INVALID_TARGET_MENU = "validation.invalid_target_menu";
    public static String VALIDATION_INVALID_ECONOMY_ACTION = "validation.invalid_economy_action";
    public static String VALIDATION_INVALID_ECONOMY_AMOUNT = "validation.invalid_economy_amount";
    public static String VALIDATION_INVALID_COMMAND_FORMAT = "validation.invalid_command_format";
    public static String VALIDATION_INVALID_PATTERN = "validation.invalid_pattern";
    public static String VALIDATION_INVALID_EMAIL_FORMAT = "validation.invalid_email_format";
    public static String VALIDATION_INVALID_PLAYER_NAME = "validation.invalid_player_name";
    public static String VALIDATION_INVALID_PERMISSION_FORMAT = "validation.invalid_permission_format";
    public static String VALIDATION_INVALID_MONETARY_AMOUNT = "validation.invalid_monetary_amount";
    public static String VALIDATION_RULE_FAILED = "validation.rule_failed";
    public static String VALIDATION_INVALID_CONDITION_FORMAT = "validation.invalid_condition_format";
    public static String VALIDATION_INVALID_CONDITION_NOT_FORMAT = "validation.invalid_condition_not_format";
    public static String VALIDATION_CONDITION_EVALUATION_ERROR = "validation.condition_evaluation_error";
    public static String VALIDATION_PLACEHOLDER_CONDITION_ERROR = "validation.placeholder_condition_error";
    public static String VALIDATION_INVALID_STEP_INDEX = "validation.invalid_step_index";


    public static String ACTIONS_SOUND_NO_SOUND_SPECIFIED = "actions.sound.no_sound_specified";
    public static String ACTIONS_SOUND_INVALID_VOLUME = "actions.sound.invalid_volume";
    public static String ACTIONS_SOUND_INVALID_PITCH = "actions.sound.invalid_pitch";
    public static String ACTIONS_SOUND_SOUND_PLAYED = "actions.sound.sound_played";
    public static String ACTIONS_SOUND_PLAY_FAILED = "actions.sound.play_failed";
    public static String ACTIONS_SOUND_PLAY_ERROR = "actions.sound.play_error";


    public static String ACTIONS_TITLE_INVALID_PARAMETERS = "actions.title.invalid_parameters";
    public static String ACTIONS_TITLE_SYSTEM_UNAVAILABLE = "actions.title.system_unavailable";
    public static String ACTIONS_TITLE_TITLE_SENT = "actions.title.title_sent";
    public static String ACTIONS_TITLE_SEND_FAILED = "actions.title.send_failed";
    public static String ACTIONS_TITLE_SEND_ERROR = "actions.title.send_error";

    public static String ACTIONS_SERVER_INVALID_PARAMETERS = "actions.server.invalid_parameters";
    public static String ACTIONS_SERVER_NO_COMMAND_SPECIFIED = "actions.server.no_command_specified";
    public static String ACTIONS_SERVER_COMMAND_EXECUTED = "actions.server.command_executed";
    public static String ACTIONS_SERVER_EXECUTION_FAILED = "actions.server.execution_failed";
    public static String ACTIONS_SERVER_EXECUTION_ERROR = "actions.server.execution_error";

    public static String ACTIONS_RANDOM_ACTION_EXECUTED = "actions.random.action_executed";
    public static String ACTIONS_RANDOM_ACTION_FAILED = "actions.random.action_failed";
    public static String ACTIONS_RANDOM_EXECUTION_INTERRUPTED = "actions.random.execution_interrupted";
    public static String ACTIONS_RANDOM_EXECUTION_FAILED = "actions.random.execution_failed";

    public static String FORMS_MODAL_DISPLAY_ERROR = "forms.modal_display_error";
    public static String FORMS_MENU_DISPLAY_ERROR = "forms.menu_display_error";
    public static String FORMS_CUSTOM_DISPLAY_ERROR = "forms.custom_display_error";
    ...
    public static String FORMS_FALLBACK_MESSAGE_SENT = "forms.fallback_message_sent";
    public static String FORMS_FALLBACK_ERROR = "forms.fallback_error";

    public static String INTEGRATIONS_PLACEHOLDERAPI_NOT_FOUND = "integrations.placeholderapi.not_found";
    public static String INTEGRATIONS_PLACEHOLDERAPI_INITIALIZED = "integrations.placeholderapi.initialized";
    public static String INTEGRATIONS_PLACEHOLDERAPI_CLASS_NOT_FOUND = "integrations.placeholderapi.class_not_found";
    public static String INTEGRATIONS_PLACEHOLDERAPI_INIT_FAILED = "integrations.placeholderapi.init_failed";

    public static String ERRORS_OPERATION_FAILED = "errors.operation_failed";
    public static String ERRORS_OPERATION_FAILED_FALLBACK = "errors.operation_failed_fallback";
    public static String ERRORS_FALLBACK_FAILED = "errors.fallback_failed";
    public static String ERRORS_OPERATION_TIMEOUT = "errors.operation_timeout";
    public static String ERRORS_FALLBACK_ERROR = "errors.fallback_error";
    public static String ERRORS_START_FAILED = "errors.start_failed";
    public static String ERRORS_ACTION_RESULT_ERROR = "errors.action_result_error";
    public static String ERRORS_BASIC_FALLBACK = "errors.basic_fallback";

    public static String EVENTS_HANDLER_ERROR = "events.handler_error";
    public static String EVENTS_LISTENER_ERROR = "events.listener_error";
    public static String EVENTS_VALIDATION_FAILED = "events.validation_failed";
    public static String EVENTS_FORM_CLOSED = "events.form_closed";
    public static String EVENTS_FORM_ERROR = "events.form_error";
    public static String EVENTS_SEND_FAILED = "events.send_failed";
    ...
    public static String VALIDATION_BUTTON_NO_ACTION = "validation.button_no_action";
    public static String VALIDATION_UNKNOWN_ACTION_TYPE = "validation.unknown_action_type";
    public static String VALIDATION_EMPTY_ACTION_VALUE = "validation.empty_action_value";
    public static String VALIDATION_LEGACY_FORMAT_DETECTED = "validation.legacy_format_detected";
    public static String VALIDATION_INVALID_SIZE = "validation.invalid_size";
    public static String VALIDATION_INVALID_INTERVAL = "validation.invalid_interval";
    public static String VALIDATION_DIRECTORY_NOT_FOUND = "validation.directory_not_found";
    public static String VALIDATION_DIRECTORY_NOT_READABLE = "validation.directory_not_readable";
